...
const char ARCHIVO_USUARIOS[] = "usuarios.dat";
...
public:
    ...
    bool cambiarContrasena(
        const string& contrasenaAnterior,
        const string& contrasenaNueva,
        string& mensajeError
    );
...
public:
    static bool guardarUsuarios(
        const SistemaUsuarios& sistemaUsuarios,
    ...
    static bool existePartidaGuardada(const string& nombreUsuario);
    static bool eliminarPartidaGuardada(const string& nombreUsuario);
};
...
string calcularHashContrasena(const string& contrasena);
